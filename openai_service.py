...
6. 重要：只有在用户提供的关键人物真正不足以构成完整闭环时，才需要在suggested_roles_to_hunt中建议补充，如果现有人物已经够用，该数组可以为空[]
...
{{
  "overview": {{
    ...
    "gaps": ["缺少的关键角色或环节1","..."（如果用户提供的关键人物已经够用，此数组可以为空）],
    "suggested_roles_to_hunt": [
      ...
      // 注意：只有在真正缺少关键角色时才需要建议补充，如果用户提供的关键人物已经能构成完整闭环，此数组可以为空[]
    ]
  }},
  "paths": [
    {{
